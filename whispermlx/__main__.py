...
def cli():
    ...
    parser.add_argument("--device", default="mps", help="device for PyTorch models (VAD, alignment, diarization); MLX Whisper inference uses Apple Silicon GPU automatically")
